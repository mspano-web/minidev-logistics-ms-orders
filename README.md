...
# MiniDev-Logistic:  ms-orders

La presente iniciativa contiene el codigo de un mini desarrollo de software BackEnd.
En particular, este proyecto contiene el modulo denominado ms-orders.
...
In particular, this project contains the module called ms-orders.
